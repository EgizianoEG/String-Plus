...
export type StringPlusPascal = {
	...
	SortByLength: (Array: {string}, Order: Enum.SortDirection?) -> {string},
	AlphabeticalOrder: (Array: {string}, Order: Enum.SortDirection?) -> {string},
	...
	Expand: (Str: string, Subset: {[string | number]: any}) -> (string, number),
